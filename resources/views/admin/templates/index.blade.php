...
@section('content')
    ...
    {{-- BARIS ATAS: AKSI KIRI, FILTER KANAN --}}
    <div class="mb-6 flex items-center justify-between flex-wrap gap-4">
        ...
        <form method="GET" class="flex items-center gap-2">
            ...
            <select name="category" class="pl-3 pr-9 py-1 text-sm border rounded-md" onchange="this.form.submit()">
            ...
            @if(request('category'))
                <a href="{{ route('admin.templates.index') }}" class="text-sm text-gray-500 underline">
                    Reset
                </a>
            @endif
        </form>
        ...
        @forelse($templates as $template)
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                : 'bg-red-100 text-red-700' }}">
                            {{ $template->status ? 'Aktif' : 'Tidak Aktif' }}
                        </span>
